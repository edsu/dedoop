...
def test_csv():
    ...
    row = next(reader)
    assert row['path'] == '1e89b90b5973baad2e6c3294ffe648ff53ab0b9d75188e9fbb8b38deb9ba3341.png'
    ...
    row = next(reader)
    assert row['path'] == '45d257c93e59ec35187c6a34c8e62e72c3e9cfbb548984d6f6e8deb84bac41f4.jpg'
